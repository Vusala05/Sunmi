  ...
  private lateinit var binding: FragmentHomeBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.printCheck.setOnClickListener {
            findNavController().navigate(HomeFragmentDirections.Companion.actionHomeFragmentToTicketFragment())
        }

        binding.printPhoto.setOnClickListener {
            findNavController().navigate(HomeFragmentDirections.Companion.actionHomeFragmentToPhotoFragment())
        }
    }
